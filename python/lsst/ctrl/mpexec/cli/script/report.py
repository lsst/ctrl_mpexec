...
def report_v2(
    ...
    if view_graph:
        ...
        if full_output_filename or exception_diagnostics_filename or show_exception_diagnostics:
            print("Warning: you have requested to write the summary to a file or show or save exception "
...
def infer_write_format_from_filename(filename, default="jsviewer"):
